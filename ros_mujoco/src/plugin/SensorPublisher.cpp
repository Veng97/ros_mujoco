...
SensorPublisher::SensorPublisher(const mjModel* m, mjData*, int sensor_id, MessageType msg_type, const std::string& frame_id, const std::string& topic_name, mjtNum publish_rate)
...
void SensorPublisher::reset(const mjModel*, int) { iteration_count_ = 0; }

void SensorPublisher::compute(const mjModel* m, mjData* d, int)
{
  ++iteration_count_;
